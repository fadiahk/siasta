		...
		<header id="header" id="home">
			...
			<div class="container main-menu">
				<div class="row align-items-center justify-content-between d-flex">
					<div id="logo">
						<a class="main-logo" href="about.php"><img src="img/logo-siasta.png" width="70" alt="40"></a>
					</div>
					<nav id="nav-menu-container">
						<ul class="nav-menu">
							<li class="menu-active"><a href="index.php">Home</a></li>
							<li><a href="about.php">About</a></li>
							<li><a href="studentproduct.php">Student Product</a></li>
							<li class="menu-has-children"><a href="">In Here</a>
								<ul>
									<li><a href="news.php">News</a></li>
									<li><a href="ekstrak.php">Ekstrakulikuler</a></li>
								</ul>
			...
			<div class="container">
				<div class="row fullscreen d-flex justify-content-center align-items-center">
					<div class="banner-content col-lg-9 col-md-12 justify-content-center ">
						<h1>
							Welcome To School IT<br>
							SIASTA 8
						</h1>
						<p class="text-white mx-auto">
							Favorite School
						</p>
						<a href="#" class="primary-btn text-uppercase mt-10">Get Started</a>
					</div>
				</div>
			</div>
		</section>
					...
					<div class="col-lg-5 col-md-6 col-sm-6">
						<div class="single-footer-widget">
							...
							<p class="footer-text">
								...
								</script> All rights reserved | This template is made with <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank">Colorlib</a> and distributed by <a href="https://themewagon.com/" target="_blank">ThemeWagon</a>
								<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
							</p>
						</div>
					</div>
