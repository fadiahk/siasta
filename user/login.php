...
<body class="hold-transition login-page">
  <div class="login-box">
    ...
    <div class="card card-outline card-primary">
      ...
      <div class="card-body">
        <p class="login-box-msg">Selamat datang di halaman login SIASTA</p>
...
if (isset($_POST['login'])) {
  ...
  if ($user == $username && $pass == $password) {
    ...
    echo 'maaf ada kesalahan penginputan atau anda belum melakukan register';
  }
}
?>